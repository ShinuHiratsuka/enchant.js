 ...
 * @type {Object}
 */
enchant.ui = { assets: ['img/font0.png'] };
...
enchant.ui.Pad = enchant.Class.create(enchant.Sprite, {
     ...
     */
    initialize: function() {
        var core = enchant.Game.instance;
//        var image = core.assets['img/pad.png'];
        ...
        this.addEventListener('touchstart', function(e) {
            ...
            var pos = this.parentNode._element.getBoundingClientRect();
            x=Math.floor(e.x - ((pos.left) / game.scale))-this.x;
            y=Math.floor(e.y - ((pos.top) / game.scale))-this.y;

            this._updateInput(this._detectInput(x, y));
        });
